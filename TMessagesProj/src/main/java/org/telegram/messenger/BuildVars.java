...
public class BuildVars {
    ...
    // KamiGram: injected from gradle (gradle.properties or CI secrets), never hardcoded
    public static int APP_ID = BuildConfig.APP_ID;
    public static String APP_HASH = BuildConfig.APP_HASH;

    // SafetyNet key for Google Identity SDK, empty disables it (KamiGram has no own key)
    public static String SAFETYNET_KEY = "";
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=com.kaminari.gram";
    public static String HUAWEI_STORE_URL = "";
    // Google sign-in client id belongs to the official app; empty disables that login path
